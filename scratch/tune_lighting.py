...
def build_svg_calib(s3="#BAABA0", s4="#9E8C7F", s5="#685648", r_op=0.60):
  ...
  <defs>
    ...
    <linearGradient id="rWingShadow" x1="10%" y1="20%" x2="90%" y2="80%">
      ...
      <stop offset="45%" stop-color="#8E7E70" stop-opacity="{r_op * 0.7}" />
      <stop offset="100%" stop-color="#554436" stop-opacity="{r_op}" />
    </linearGradient>
...
svg_content = build_svg_calib()
with open("scratch/test_tune_lighting.svg", "w") as f:
    f.write(svg_content)
out_png = render_svg("scratch/test_tune_lighting.svg", "scratch/test_tune_lighting.png")
