...
def build_ellipse_eye_svg():
  ...
  <defs>
    ...
    <!-- Left Eye Radial (Amber crescent on outer left and bottom) -->
    ...
    <!-- Right Eye Radial (Amber glow on outer right and bottom) -->
...
svg_content = build_ellipse_eye_svg()
with open("scratch/test_ellipse_eye.svg", "w") as f:
    f.write(svg_content)
out_png = render_svg("scratch/test_ellipse_eye.svg", "scratch/test_ellipse_eye.png")
