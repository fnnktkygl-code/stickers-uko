...
def build_v5_svg():
  ...
  <!-- 3. Facial Depressions & Shading (Smooth radial falloffs) -->
  ...
  <g id="left_eye">
    ...
    <path d="M 176 168 C 184 176, 206 176, 214 168" stroke="#FFE275" stroke-width="2.2" stroke-linecap="round" opacity="0.80" fill="none" />
    <!-- Eyelid Cast Shadow on eyeball -->
  ...
  <g id="right_eye">
    ...
    <!-- Golden Amber Inner Glow Arc -->
    <path d="M 294 168 C 302 176, 322 176, 330 168" stroke="#FCD65C" stroke-width="2.2" stroke-linecap="round" opacity="0.70" fill="none" />
    <!-- Eyelid Cast Shadow -->
  ...
  <!-- 5. Seamless Rounded Porcelain Beak Droplet (Zero Stroke) -->
  <g id="beak">
...
if __name__ == "__main__":
    svg = build_v5_svg()
    with open("scratch/test_owluko_master_v5.svg", "w") as f:
        f.write(svg)
    png = render_svg("scratch/test_owluko_master_v5.svg", "scratch/test_owluko_master_v5.png")
    evaluate_fidelity(png, out_board_path="scratch/owluko_fidelity_audit_v5.png", title="OWLUKO MASTER V5 SOFT PORCELAIN")
    eval_face_svg("scratch/test_owluko_master_v5.svg")
    eval_feet_svg("scratch/test_owluko_master_v5.svg")
