...
svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512" style="background: transparent;">
  <defs>
    ...
    <!-- Feet Pods Calibrated -->
    <linearGradient id="footGrad" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#DAD2CC" />
      <stop offset="35%" stop-color="#C2B7B0" />
      <stop offset="70%" stop-color="#A59A94" />
      <stop offset="100%" stop-color="#847A74" />
    </linearGradient>
...
with open("scratch/test_aituko_calibrated_v16.svg", "w") as f:
    f.write(svg)

png = render_svg_chrome("scratch/test_aituko_calibrated_v16.svg", "scratch/test_aituko_calibrated_v16.png")
