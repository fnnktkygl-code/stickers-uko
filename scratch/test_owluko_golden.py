...
def create_golden_owluko(path="scratch/test_owluko_golden.svg"):
  ...
  <defs>
    ...
    <!-- Master Porcelain Body Gradient (Seamless Warm Cream Porcelain) -->
    ...
    <!-- True Translucent Honey Amber Iris (Left Eye) -->
    ...
    <!-- True Translucent Honey Amber Iris (Right Eye) -->
    ...
    <!-- True Porcelain Cream Eyelid Hoods (Matches Facial Disc) -->
    ...
    <radialGradient id="rBrowShadow" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#806550" stop-opacity="0.32" />
      <stop offset="60%" stop-color="#806550" stop-opacity="0.14" />
      <stop offset="100%" stop-color="#806550" stop-opacity="0" />
    </radialGradient>

    <!-- True 3D Feet Volumetric Gradients -->
  ...
  <g clip-path="url(#bodyClip)">
    ...
    <path d="M 368 185 C 362 225, 362 280, 368 355 C 370 370, 375 385, 380 395" stroke="#66503E" stroke-width="2.8" stroke-linecap="round" opacity="0.35" fill="none" />
  ...
  <ellipse cx="195" cy="155" rx="36" ry="30" fill="#8E7562" opacity="0.08" />
  ...
  <!-- 5. Seamless Rounded Porcelain Beak Cone (Y: 146 to 204) -->
  <g id="beak">
...
if __name__ == "__main__":
    svg_path = create_golden_owluko()
    rendered = render_svg_chrome(svg_path, "scratch/temp_owluko_golden.png")
    res = evaluate(rendered)
    print(f"[GOLDEN] IoU: {res['iou']*100:.2f}%, SSIM: {res['ssim']*100:.2f}%, NCC: {res['ncc']*100:.2f}%, Delta E: {res['delta_e']:.2f}, MSE: {res['mse']:.1f}")
