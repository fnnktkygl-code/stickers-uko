...
def create_v22(path="scratch/test_owluko_v22.svg"):
  ...
  <defs>
    ...
    <!-- Left Eye Amber Iris Gradient (Liquid Amber Depth) -->
    <linearGradient id="amberEyeL" x1="45%" y1="10%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#552D08" />
      <stop offset="30%" stop-color="#6E3A10" />
      <stop offset="60%" stop-color="#A86A22" />
      <stop offset="85%" stop-color="#C59A55" />
      <stop offset="100%" stop-color="#B8863A" />
    </linearGradient>

    <!-- Right Eye Amber Iris Gradient -->
    <linearGradient id="amberEyeR" x1="55%" y1="10%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#3B1C00" />
      <stop offset="30%" stop-color="#502808" />
      <stop offset="60%" stop-color="#885215" />
      <stop offset="85%" stop-color="#BA934B" />
      <stop offset="100%" stop-color="#A47C32" />
    </linearGradient>
  ...
  <g clip-path="url(#bodyClip)">
    ...
    <ellipse cx="163" cy="473" rx="7.5" ry="4.5" fill="#FFFFFF" opacity="0.24" />
    <ellipse cx="187" cy="476" rx="8.5" ry="5.5" fill="#FFFFFF" opacity="0.28" />
    <ellipse cx="218" cy="477" rx="7.5" ry="4.5" fill="#FFFFFF" opacity="0.24" />
    <!-- Left Foot Soft Crevices (Calibrated to Ref Valleys: 172, 209) -->
    <ellipse cx="172" cy="468" rx="2.8" ry="8" fill="#A78C73" opacity="0.40" />
    <ellipse cx="209" cy="465" rx="2.8" ry="8" fill="#A68B72" opacity="0.40" />
    ...
    <ellipse cx="323" cy="466" rx="8.5" ry="5.5" fill="#FFFFFF" opacity="0.26" />
    <ellipse cx="346" cy="472" rx="7.5" ry="4.5" fill="#FFFFFF" opacity="0.18" />
    <!-- Right Foot Soft Crevices (Calibrated to Ref Valleys: 298, 339) -->
    <ellipse cx="298" cy="471" rx="2.8" ry="8" fill="#7A624C" opacity="0.45" />
    <ellipse cx="339" cy="472" rx="2.8" ry="8" fill="#816852" opacity="0.45" />
  </g>
  ...
  <g id="left_eye">
    ...
    <ellipse cx="220" cy="175" rx="2.5" ry="3.5" fill="#FFFFFF" opacity="0.95" />
    <ellipse cx="220" cy="175" rx="4.0" ry="5.0" fill="#FFE8A5" opacity="0.35" />
  ...
  <g id="right_eye">
    ...
    <ellipse cx="326" cy="165" rx="1.3" ry="2.0" fill="#FFFFFF" opacity="0.92" />
    <!-- Porcelain Upper Eyelid Hood -->
...
if __name__ == "__main__":
    svg_path = create_v22()
    rendered = render_svg_chrome(svg_path, "scratch/temp_owluko_v22.png")
    res = evaluate(rendered)
    print(f"[V22] IoU: {res['iou']*100:.2f}%, SSIM: {res['ssim']*100:.2f}%, NCC: {res['ncc']*100:.2f}%, Delta E: {res['delta_e']:.2f}, MSE: {res['mse']:.1f}")
