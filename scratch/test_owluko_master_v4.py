...
def build_v4_svg():
  ...
  <defs>
    ...
    <!-- Cranial Dome Specular Highlight (Peak at 215, 85) -->
    ...
    <radialGradient id="amberEyeL" cx="35%" cy="75%" r="70%">
    ...
    <!-- Right Amber Iris -->
    <radialGradient id="amberEyeR" cx="65%" cy="75%" r="70%">
  ...
  <g clip-path="url(#bodyClip)">
    ...
    <ellipse cx="254" cy="405" rx="85" ry="30" fill="#755F4E" opacity="0.28" />
    <ellipse cx="256" cy="442" rx="65" ry="18" fill="#523D2C" opacity="0.38" />
  ...
  <ellipse cx="254" cy="150" rx="12" ry="20" fill="#D4C0AF" opacity="0.40" />
  ...
  <ellipse cx="274" cy="160" rx="15" ry="20" fill="#826855" opacity="0.32" />
  <ellipse cx="264" cy="182" rx="12" ry="18" fill="#826855" opacity="0.28" />
  ...
  <g id="left_eye">
    ...
    <ellipse cx="195" cy="161" rx="10" ry="8.0" fill="url(#pupilGrad)" />
    ...
    <ellipse cx="180" cy="164" rx="3.2" ry="2.2" fill="#FFF0C2" opacity="0.95" />
    <circle cx="180" cy="164" r="1.4" fill="#FFFFFF" opacity="0.95" />
    ...
    <path d="M 166 142 L 177 140 L 190 139 L 215 143 L 224 148" stroke="#5E3517" stroke-width="1.0" stroke-linecap="round" fill="none" />
  </g>
  ...
  <g id="right_eye">
    ...
    <!-- Pupil centered in lower iris -->
    <ellipse cx="312" cy="161" rx="10" ry="8.0" fill="url(#pupilGrad)" />
    <!-- Golden Amber Inner Glow Arc -->
    ...
    <!-- Specular Reflection Glint -->
    <ellipse cx="298" cy="164" rx="2.8" ry="2.0" fill="#FFE8AA" opacity="0.85" />
    <circle cx="298" cy="164" r="1.2" fill="#FFFFFF" opacity="0.90" />
    ...
    <path d="M 284 144 L 296 141 L 313 139 L 334 141 L 340 145" stroke="#4C280D" stroke-width="1.0" stroke-linecap="round" fill="none" />
  </g>
...
if __name__ == "__main__":
    svg = build_v4_svg()
    with open("scratch/test_owluko_master_v4.svg", "w") as f:
        f.write(svg)
    png = render_svg("scratch/test_owluko_master_v4.svg", "scratch/test_owluko_master_v4.png")
    evaluate_fidelity(png, out_board_path="scratch/owluko_fidelity_audit_v4.png", title="OWLUKO MASTER V4 PRECISION VECTOR")
    eval_face_svg("scratch/test_owluko_master_v4.svg")
    eval_feet_svg("scratch/test_owluko_master_v4.svg")
