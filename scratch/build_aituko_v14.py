...
svg = f"""<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512" style="background: transparent;">
  <defs>
    ...
    <!-- Pelvis Base AO Shadow (Y in [370, 409]) -->
    <radialGradient id="pelvisAOGrad" cx="50%" cy="85%" r="70%">
      <stop offset="0%" stop-color="#181410" stop-opacity="0.88" />
      <stop offset="45%" stop-color="#3E342B" stop-opacity="0.58" />
      <stop offset="80%" stop-color="#786B5E" stop-opacity="0.22" />
      <stop offset="100%" stop-color="#A89B8E" stop-opacity="0.0" />
    </radialGradient>
  ...
  <g clip-path="url(#bodyClip)">
    ...
    <!-- Mechanical Neck Collar -->
    <ellipse cx="257" cy="204" rx="14" ry="7" fill="#151922" stroke="#252C3C" stroke-width="0.8" />
...
with open("scratch/test_aituko_calibrated_v14.svg", "w") as f:
    f.write(svg)

png = render_svg_chrome("scratch/test_aituko_calibrated_v14.svg", "scratch/test_aituko_calibrated_v14.png")
