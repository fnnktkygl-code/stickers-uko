...
def create_flawless_owluko(path="scratch/test_owluko_flawless.svg"):
  ...
  <defs>
    ...
    <!-- Master Porcelain Body Gradient (Luminous Continuous Porcelain Egg) -->
    <linearGradient id="bodyGrad" x1="28%" y1="6%" x2="72%" y2="94%">
      <stop offset="0%" stop-color="#FCF5EC" />
      <stop offset="14%" stop-color="#F8ECE0" />
      <stop offset="35%" stop-color="#EAD9CA" />
      <stop offset="58%" stop-color="#D6C3B1" />
      <stop offset="78%" stop-color="#B29C8A" />
      <stop offset="92%" stop-color="#8C7462" />
      <stop offset="100%" stop-color="#6E5646" />
    </linearGradient>

    <!-- Cranial Dome Specular Highlight -->
    <radialGradient id="cranialHl" cx="44%" cy="17%" r="36%">
      <stop offset="0%" stop-color="#FFFDF9" stop-opacity="0.40" />
      <stop offset="50%" stop-color="#F8EFE5" stop-opacity="0.15" />
    ...
    <radialGradient id="headRightShadow" cx="72%" cy="18%" r="42%">
      ...
      <stop offset="65%" stop-color="#7A6250" stop-opacity="0.08" />
    ...
    <linearGradient id="rWingShadow" x1="0%" y1="20%" x2="100%" y2="80%">
      ...
      <stop offset="45%" stop-color="#A8927E" stop-opacity="0.26" />
      <stop offset="100%" stop-color="#6B5442" stop-opacity="0.58" />
    </linearGradient>

    <!-- Left Eye Amber Iris Gradient (Liquid Translucent Amber) -->
    <radialGradient id="amberEyeL" cx="45%" cy="65%" r="62%">
      <stop offset="0%" stop-color="#E8A236" />
      <stop offset="35%" stop-color="#C57C24" />
    ...
    <!-- True Porcelain Ivory Upper Eyelid Hoods (Preserves Porcelain Radiance) -->
    <linearGradient id="eyelidHoodL" x1="45%" y1="0%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#FFFDF9" />
      <stop offset="40%" stop-color="#FAF0E6" />
      <stop offset="80%" stop-color="#EAD8C7" />
      <stop offset="94%" stop-color="#D2BBA7" />
      <stop offset="100%" stop-color="#9C7E66" />
    </linearGradient>

    <linearGradient id="eyelidHoodR" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#F2E6D8" />
      <stop offset="40%" stop-color="#E8DACB" />
      <stop offset="80%" stop-color="#D5C0AE" />
      <stop offset="94%" stop-color="#BCA38F" />
      <stop offset="100%" stop-color="#886B54" />
    </linearGradient>

    <!-- Eyelid Margin Cast Shadow on Eyeball -->
    <linearGradient id="eyeShadow" x1="50%" y1="0%" x2="50%" y2="100%">
      <stop offset="0%" stop-color="#140601" stop-opacity="0.88" />
      <stop offset="50%" stop-color="#3A1A04" stop-opacity="0.45" />
      <stop offset="100%" stop-color="#7C3B07" stop-opacity="0" />
    </linearGradient>

    <!-- Seamless Rounded Porcelain Beak Gradient -->
    <linearGradient id="beakGrad" x1="20%" y1="0%" x2="80%" y2="100%">
      <stop offset="0%" stop-color="#FAF0E4" />
      <stop offset="25%" stop-color="#E8D5C3" />
      <stop offset="65%" stop-color="#BA9E86" />
      <stop offset="100%" stop-color="#7C624E" />
    </linearGradient>
    ...
    <!-- Feet Volumetric Gradients (Continuous porcelain digits) -->
  ...
  <g clip-path="url(#bodyClip)">
    ...
    <path d="M 125 185 C 135 225, 138 280, 130 355 C 128 370, 122 385, 118 395" stroke="#B8A492" stroke-width="2.0" stroke-linecap="round" opacity="0.22" fill="none" />
    ...
    <path d="M 368 185 C 362 225, 362 280, 368 355 C 370 370, 375 385, 380 395" stroke="#66503E" stroke-width="2.5" stroke-linecap="round" opacity="0.28" fill="none" />
    ...
    <ellipse cx="172" cy="470" rx="3.0" ry="10" fill="#2D1B0E" opacity="0.25" />
    <ellipse cx="208" cy="470" rx="3.0" ry="10" fill="#2D1B0E" opacity="0.25" />
    ...
    <ellipse cx="298" cy="471" rx="3.0" ry="10" fill="#25160A" opacity="0.28" />
    <ellipse cx="339" cy="472" rx="3.0" ry="10" fill="#25160A" opacity="0.28" />
  </g>

  <!-- 3. Facial Depressions & Eye Orbits -->
  <!-- Left Orbit Cavity Soft Radial Shadow -->
  <ellipse cx="195" cy="155" rx="38" ry="32" fill="#8E7562" opacity="0.10" />
  <!-- Right Orbit Cavity Soft Radial Shadow -->
  <ellipse cx="312" cy="155" rx="38" ry="32" fill="#785F4D" opacity="0.18" />

  <!-- 4. Sleepy Hooded Glassy Amber Eyes (True Drowsy 3D CGI Morphology) -->
  <!-- LEFT EYE -->
  <g id="left_eye">
    <!-- Amber Iris Sphere (Height 40px, curved sleepy aperture) -->
    ...
    <!-- Pupil / Deep Core -->
    <ellipse cx="195" cy="158" rx="9" ry="11" fill="#1C0A02" opacity="0.75" />
    
    <!-- Glowing Honey Amber Subsurface Scattering Crescent -->
    <path d="M 172 162 C 182 174, 204 176, 218 166 C 214 175, 198 181, 185 180 C 176 178, 172 170, 172 162 Z" fill="#FFA726" opacity="0.65" />
    ...
    <!-- Eyelid Keylight Peak -->
    <ellipse cx="195" cy="128" rx="14" ry="5" fill="#FFFFFF" opacity="0.22" />
  </g>
  ...
  <g id="right_eye">
    ...
    <!-- Pupil / Deep Core -->
    <ellipse cx="312" cy="158" rx="9" ry="11" fill="#140601" opacity="0.75" />
    
    <!-- Glowing Amber Lower Crescent -->
    ...
    <!-- Eyelid Keylight Peak -->
    <ellipse cx="312" cy="128" rx="13" ry="5" fill="#FFFFFF" opacity="0.16" />
  </g>
  ...
  <g id="beak">
    ...
    <path d="M 246 146 C 251 144, 257 144, 262 146 C 266 154, 267 170, 266 186 C 265 195, 260 201, 254 201 C 248 201, 243 195, 242 186 C 241 170, 242 154, 246 146 Z" fill="url(#beakGrad)" />
...
if __name__ == "__main__":
    svg_path = create_flawless_owluko()
    rendered = render_svg_chrome(svg_path, "scratch/temp_owluko_flawless.png")
    res = evaluate(rendered)
    print(f"[FLAWLESS] IoU: {res['iou']*100:.2f}%, SSIM: {res['ssim']*100:.2f}%, NCC: {res['ncc']*100:.2f}%, Delta E: {res['delta_e']:.2f}, MSE: {res['mse']:.1f}")
