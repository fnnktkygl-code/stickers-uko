...
<body>
  <img src="file://{abs_svg}" />
    ...
    html_path = "scratch/render_simp_1024_tmp.html"
...
def make_comparison_board(ref_path, render_path, out_board):
    ...
    draw.text((24, 24), "OWLUKO SIMPLIFIE : NOUVELLE REFERENCE UTILISATEUR VS NOUVEAU MODELE VECTORIEL PUR", fill=(255, 255, 255))
    draw.text((30, 65), "1. NOUVELLE IMAGE MASTER UTILISATEUR (media_1788762944348.png)", fill=(245, 158, 11))
    draw.text((1070, 65), "2. NOUVEAU MODELE VECTORIEL (scratch/owluko_simplified_master.svg)", fill=(56, 189, 248))
...
if __name__ == "__main__":
    render_svg_1024("scratch/owluko_simplified_master.svg", "scratch/owluko_simplified_master.png")
    make_comparison_board("mascots/owluko/owluko_simplified_master_ref.png", "scratch/owluko_simplified_master.png", "scratch/owluko_simplified_comp_board.png")
