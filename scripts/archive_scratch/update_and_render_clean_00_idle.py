...
shutil.copy(f"{artifact_dir}/usako_master_clean_1788030885302.jpg", "mascots/usako/master/usako_greenscreen_master.jpg")
shutil.copy(f"{artifact_dir}/hatoko_master_clean_1788030903693.jpg", "mascots/hatoko/master/hatoko_greenscreen_master.jpg")
...
for m_key, m_path, m_title, needs_keying in mascots:
    ...
    static_png = f"{mb_dir}/{m_key}_static.png"
    anim_gif = f"{mb_dir}/{m_key}_animated.gif"
    ...
    print(f"✨ 00_idle mis à jour pour {m_title}: OK")
...
grid_dark.save(f"{mb_dir}/moodboard_00_idle_dark_grid.png")
grid_light.save(f"{mb_dir}/moodboard_00_idle_light_grid.png")

print("🎉 Grilles 00_idle mises à jour avec Usako et Hatoko nettoyés !")
