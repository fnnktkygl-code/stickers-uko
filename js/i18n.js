 ...
 * Hardened & High-Performance Edition: 7 Langues Natives (EN, FR, ES, DE, JA, PT, ZH)
 */
...
const TRANSLATIONS = {
  "fr": {
    ...
    "messages": {
      ...
      "inuko": {
        "idle": "Garde vigilante et fidèle.",
    ...
    "catalogue": {
      ...
      "voteSubtitle": "Quelle sera la prochaine mascotte ?"
    },
    "candidates": {
      "owluko": "🦉 Owluko (Chouette)",
      "luneko": "🐱 Luneko (Chat)"
    },
    "pricing": {
      "badge": "Pack Unique",
      "title": "Un seul pack. Tout AItuko.",
      "desc": "Licence commerciale perpétuelle incluse — usage personnel et commercial illimité.",
      "uniqueBadge": "Pack Unique",
      "uniqueTitle": "Pack AItuko",
      "uniquePrice": "5,99 €",
      "uniqueDesc": "Paiement unique • Aucun abonnement • Accès immédiat",
      "uniqueItem1": "Pack complet des 12 états essentiels (Onboarding, Succès, Erreur, Chargement...)",
      "uniqueItem2": "Multi-formats inclus : Lottie vectoriel (< 50 Ko), WebP 60fps animé & PNG HD",
      "uniqueItem3": "Composants prêts à copier pour React / Next.js, Vue, Flutter & HTML",
      "uniqueItem4": "Détourage transparent net sur fond sombre et fond clair",
      "uniqueItem5": "Licence commerciale perpétuelle illimitée",
      "uniqueBtn": "📦 Obtenir le Pack AItuko — 5,99 €"
    },
    "modal": {
  ...
  "en": {
    ...
    "messages": {
      ...
      "inuko": {
        "idle": "Vigilant and faithful guard.",
    ...
    "catalogue": {
      ...
      "voteSubtitle": "Which mascot should we make next?"
    },
    "candidates": {
      "owluko": "🦉 Owluko (Owl)",
      "luneko": "🐱 Luneko (Cat)"
    ...
    "pricing": {
      "badge": "Single Pack",
      "title": "One pack. All of AItuko.",
      "desc": "Perpetual commercial license included — unlimited personal and commercial use.",
      "uniqueBadge": "Single Pack",
      "uniqueTitle": "AItuko Pack",
      "uniquePrice": "5.99 €",
      "uniqueDesc": "One-time payment • No subscription • Instant access",
      "uniqueItem1": "Complete pack of 12 essential states (Onboarding, Success, Error, Loading...)",
      "uniqueItem2": "Multi-format bundle: Pure vector Lottie (< 50 KB), animated 60fps WebP & HD PNG",
      "uniqueItem3": "Copy-paste components for React / Next.js, Vue, Flutter & HTML",
      "uniqueItem4": "Crystal-clear transparent cutout on both dark and light modes",
      "uniqueItem5": "Unlimited perpetual commercial license",
      "uniqueBtn": "📦 Get the AItuko Pack — 5.99 €"
    },
    "modal": {
  ...
  "es": {
    ...
    "catalogue": {
      ...
      "voteSubtitle": "¿Cuál será la próxima mascota?"
    },
    "candidates": {
      "owluko": "🦉 Owluko (Búho)",
      "luneko": "🐱 Luneko (Gato)"
    ...
    "pricing": {
      "badge": "Pack Único",
      "title": "Un solo pack. Todo AItuko.",
      "desc": "Licencia comercial perpetua incluida — uso personal y comercial ilimitado.",
      "uniqueBadge": "Pack Único",
      "uniqueTitle": "Pack AItuko",
      "uniquePrice": "5,99 €",
      "uniqueDesc": "Pago único • Sin suscripción • Acceso inmediato",
      "uniqueItem1": "Pack completo de los 12 estados esenciales (Onboarding, Éxito, Error, Carga...)",
      "uniqueItem2": "Múltiples formatos: Lottie vectorial (< 50 KB), WebP 60fps animado y PNG HD",
      "uniqueItem3": "Componentes listos para React / Next.js, Vue, Flutter y HTML",
      "uniqueItem4": "Transparencia nítida tanto en modo oscuro como en modo claro",
      "uniqueItem5": "Licencia comercial perpetua ilimitada",
      "uniqueBtn": "📦 Obtener el Pack AItuko — 5,99 €"
    },
    "modal": {
  ...
  "de": {
    ...
    "messages": {
      ...
      "inuko": {
        "idle": "Wachsamer und treuer Schutz.",
    ...
    "pricing": {
      "badge": "Einzelpaket",
      "title": "Ein Paket. Alles von AItuko.",
      "desc": "Lebenslange kommerzielle Lizenz — unbegrenzte persönliche und kommerzielle Nutzung.",
      "uniqueBadge": "Einzelpaket",
      "uniqueTitle": "AItuko Paket",
      "uniquePrice": "5,99 €",
      "uniqueDesc": "Einmalzahlung • Kein Abo • Sofortzugang",
      "uniqueItem1": "Komplettpaket mit 12 essenziellen Zuständen (Onboarding, Erfolg, Fehler, Laden...)",
      "uniqueItem2": "Multi-Format-Paket: Vektorbasiertes Lottie (< 50 KB), animiertes 60fps WebP & HD PNG",
      "uniqueItem3": "Sofort einsatzbereite Komponenten für React / Next.js, Vue, Flutter & HTML",
      "uniqueItem4": "Sauberer transparenter Ausschnitt für Dark- und Light-Mode",
      "uniqueItem5": "Unbegrenzte dauerhafte kommerzielle Lizenz",
      "uniqueBtn": "📦 AItuko Paket holen — 5,99 €"
    },
    "modal": {
  ...
  "ja": {
    ...
    "pricing": {
      "badge": "シングルパック",
      "title": "ひとつのパック。AItukuのすべて。",
      "desc": "永久商用ライセンス付き — 個人・商用利用無制限。",
      "uniqueBadge": "シングルパック",
      "uniqueTitle": "AItuko パック",
      "uniquePrice": "5.99 €",
      "uniqueDesc": "買い切り • サブスクなし • 即時アクセス",
      "uniqueItem1": "必須12状態の完全パック（オンボーディング・成功・エラー・読込など）",
      "uniqueItem2": "マルチフォーマット同梱：軽量Lottieベクター（50KB未満）・60fpsアニメWebP・高画質PNG",
      "uniqueItem3": "React / Next.js、Vue、Flutter、HTML用コンポーネント",
      "uniqueItem4": "ダークモード・ライトモード両対応のクリアな透過処理",
      "uniqueItem5": "無制限の永久商用ライセンス",
      "uniqueBtn": "📦 AItuko パックを入手 — 5.99 €"
    },
    "modal": {
  ...
  "pt": {
    ...
    "candidates": {
      "owluko": "🦉 Owluko (Coruja)",
      "luneko": "🐱 Luneko (Gato)"
    },
    "pricing": {
      "badge": "Pack Único",
      "title": "Um pack. Todo o AItuko.",
      "desc": "Licença comercial perpétua incluída — uso pessoal e comercial ilimitado.",
      "uniqueBadge": "Pack Único",
      "uniqueTitle": "Pack AItuko",
      "uniquePrice": "5,99 €",
      "uniqueDesc": "Pagamento único • Sem assinatura • Acesso imediato",
      "uniqueItem1": "Pacote completo com os 12 estados essenciais (Onboarding, Sucesso, Erro, Carregamento...)",
      "uniqueItem2": "Multi-formatos inclusos: Lottie vetorial (< 50 KB), WebP 60fps animado e PNG HD",
      "uniqueItem3": "Componentes prontos para React / Next.js, Vue, Flutter e HTML",
      "uniqueItem4": "Recorte transparente nítido nos temas escuro e claro",
      "uniqueItem5": "Licença comercial perpétua ilimitada",
      "uniqueBtn": "📦 Obter o Pack AItuko — 5,99 €"
    },
    "modal": {
  ...
  "zh": {
    ...
    "pricing": {
      "badge": "单一套餐",
      "title": "一个套餐，完整 AItuko。",
      "desc": "含永久商用授权 — 个人与商业用途无限制。",
      "uniqueBadge": "单一套餐",
      "uniqueTitle": "AItuko 套餐",
      "uniquePrice": "5.99 €",
      "uniqueDesc": "一次性付款 • 无订阅 • 即时获取",
      "uniqueItem1": "12个核心状态完整包（新手引导、成功、错误、加载等）",
      "uniqueItem2": "包含多格式：矢量Lottie (< 50 KB)、60fps动态WebP及高清PNG",
      "uniqueItem3": "适用于 React / Next.js、Vue、Flutter 及 HTML 的开箱即用组件",
      "uniqueItem4": "深色与浅色模式下完美的透明背景抠图",
      "uniqueItem5": "无限制永久商业授权",
      "uniqueBtn": "📦 获取 AItuko 套餐 — 5.99 €"
    },
    "modal": {
      "chooseMascot": "已选吉祥物：",
      "payBtn": "前往安全支付",
...
class I18nManager {
  ...
  get(keyPath, params = {}, fallback = undefined) {
    ...
    if (val === undefined) {
      ...
      if (keyPath.startsWith('messages.')) {
        const parts = keyPath.split('.');
        const pKey = parts[2] || 'waving';
        const defaultMsgs = {
          'waving': 'Bienvenue sur votre espace !',
          'celebrating': 'Paiement validé avec succès !',
          'ai_thinking': 'Analyse en cours...',
          'error_404': 'Page introuvable.',
          'thumbs_up': 'Parfait, c\'est validé !',
          'sleeping': 'Mode veille activé...',
          'pointing': 'Cliquez ici pour démarrer !',
          'searching': 'Recherche en cours...',
          'loading': 'Chargement...',
        ...
        return defaultMsgs[pKey] || 'Bienvenue sur votre espace !';
      }
      return keyPath;
    }
