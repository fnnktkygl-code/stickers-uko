...
const TRANSLATIONS = {
  "fr": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3 poses animées finalisées (Idle, Accueil, Guide)",
      "uniqueItem2": "Fichiers Lottie JSON + WebP 60fps + PNG HD",
      "uniqueItem3": "Composants React / Next.js prêts à l'intégration",
      "uniqueItem4": "Mises à jour incluses — 9 poses bientôt disponibles",
  ...
  "en": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3 finalized animated poses (Idle, Waving, Pointing)",
      "uniqueItem2": "Lottie JSON + 60fps WebP + HD PNG files",
      "uniqueItem3": "React / Next.js ready-to-use components",
      "uniqueItem4": "Updates included — 9 more poses coming soon",
  ...
  "es": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3 poses animadas finalizadas (Idle, Saludo, Guía)",
      "uniqueItem2": "Archivos Lottie JSON + WebP 60fps + PNG HD",
      "uniqueItem3": "Componentes React / Next.js listos para integrar",
      "uniqueItem4": "Actualizaciones incluidas — 9 poses próximamente",
  ...
  "de": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3 fertige animierte Posen (Idle, Winken, Zeigen)",
      "uniqueItem2": "Lottie JSON + WebP 60fps + PNG HD Dateien",
      "uniqueItem3": "React / Next.js Komponenten zur sofortigen Integration",
      "uniqueItem4": "Updates inklusive — 9 weitere Posen demnächst",
  ...
  "ja": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3種の完成アニメーション (Idle・Waving・Pointing)",
      "uniqueItem2": "Lottie JSON + 60fps WebP + PNG HD",
      "uniqueItem3": "React / Next.js すぐ使えるコンポーネント",
      "uniqueItem4": "アップデート込み — さらに9ポーズ近日公開",
  ...
  "pt": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3 poses animadas prontas (Idle, Aceno, Guia)",
      "uniqueItem2": "Lottie JSON + WebP 60fps + PNG HD",
      "uniqueItem3": "Componentes React / Next.js prontos a integrar",
      "uniqueItem4": "Atualizações incluídas — 9 poses em breve",
  ...
  "zh": {
    ...
    "pricing": {
      ...
      "uniqueItem1": "3个完整动画状态 (待机、挥手、指引)",
      "uniqueItem2": "Lottie JSON + 60fps WebP + 高清PNG",
      "uniqueItem3": "React / Next.js 即插即用组件",
      "uniqueItem4": "含更新 — 9个动作即将推出",
